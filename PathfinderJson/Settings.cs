...
namespace PathfinderJson
{
    public class Settings
    {
        ...
        [JsonProperty("editor.syntaxHighlight", DefaultValueHandling = DefaultValueHandling.Ignore), DefaultValue(false)]
        public bool EditorSyntaxHighlighting { get; set; } = false;
    }
}
